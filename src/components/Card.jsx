...
function Card({ value, handleonclick, addToCart }) {
	...
	return (
		...
		>
			<div id="imageContainer" className="w-[95%] h-45 lg:h-60 relative ">
			...
			>
				...
				<button
					className="px-1 py-1 lg:px-3 lg:py-2 bg-orange-300 rounded-xl text-sm font-bold hover:bg-orange-200"
					onClick={addToCart}
				>
					Add to Cart
				</button>
